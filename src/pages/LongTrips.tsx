...
export default function LongTrips() {
  ...
  const longTrips = React.useMemo(() => {
    return rides.filter((ride) => {
      ...
      // Show rides that are > 24 hours away
      return diffHours > 24;
    });
  }, [rides]);

  const filteredTrips = React.useMemo(() => {
    return longTrips.filter((ride) => {
  ...
  }, [longTrips, searchFrom, searchTo, searchDate]);
      ...
      <div className="bg-blue-600 rounded-3xl p-8 md:p-12 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-blue-100 text-lg mb-8">
            Find comfortable rides for journeys over 100km. Save money and
            travel together.
          </p>
